...
def context_manager(schedule):
    ...
    for i in range(len(classes)):
        ...
        cls['room'] = f'{classes[i].room.id} ({classes[i].room.seating_capacity})'
        cls['instructor'] = f'{classes[i].instructor.name} ({classes[i].instructor.id})'
        cls['meeting_time'] = [classes[i].meeting_time.id, classes[i].meeting_time.day, classes[i].meeting_time.time]
        context.append(cls)
    return context
...
#     template_name = 'gentimetable_doanload.html'